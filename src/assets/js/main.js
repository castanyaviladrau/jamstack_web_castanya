document.addEventListener("DOMContentLoaded", () => {
  ...
  // they never pass through Nunjucks; pageLang picks the active set.
  const uiStrings = {
    ca: {
      contactSending: "Enviant consulta...",
      contactSuccess:
      ...
      bookingSending: "Enviant solicitud...",
      bookingSuccess:
      ...
      checkoutPickupStoreRequired:
        "Selecciona la botiga on vols recollir la comanda.",
      checkoutAcceptLegal: "Has d'acceptar l'Avis legal per continuar.",
      checkoutAcceptPrivacy:
        "Has d'acceptar la Politica de privacitat per continuar.",
      checkoutAcceptFulfillment:
        "Has de confirmar que entens les condicions d'enviament i recollida.",
      orderCreateError: "No hem pogut crear la comanda.",
      resumePaymentPending: "Reprenent el pagament de la teva comanda...",
      resumeAlreadyPaid: "Aquesta comanda ja s'ha pagat correctament.",
      resumeGenericError:
        "No hem pogut reprendre el pagament d'aquesta comanda. Torna a fer la comanda des de la cistella o contacta amb nosaltres.",
      cartTitleHasItems: "REVISA LA TEVA CISTELLA",
      cartTitleEmpty: "ENCARA NO HI HA CAP PRODUCTE A LA TEVA CISTELLA",
      cartIntroHasItems:
      ...
      shippingToCalculate: "A calcular al proxim pas",
      shippingPickupFree: "Recollida a botiga (gratuit)",
      shippingFree: "Gratuit",
      cartSummaryNote:
        "La cistella es guarda en aquest navegador fins que finalitzis la compra.",
      cartCtaBackToShop: "TORNAR A LA BOTIGA",
      cartCtaKeepShopping: "SEGUIR COMPRANT",
      cartItemFormatLabel: "Format",
      cartItemUnitPriceLabel: "Preu unitari",
      cartItemQtyAria: "Quantitat",
      cartItemRemove: "Eliminar",
      shippingWarning: (min, cost) =>
        `Com que la comanda no arriba als ${min}, s'hi afegira un cost d'enviament de ${cost}. Tambe pots seleccionar recollida a botiga per evitar-lo.`,
      checkoutCartEmpty:
      ...
      checkoutGenericError: "Hi ha hagut un error en preparar la comanda.",
      checkoutSubmitLabel: "CONTINUAR CAP AL PAGAMENT",
      professionalsSlides: [
        {
          eyebrow:
            "EL NOSTRE VALOR AFEGIT: MÉS QUE UN INGREDIENT, UN PROJECTE",
          intro:
            "En triar la Castanya de Viladrau com el teu proveïdor de confiança, el teu establiment s'uneix a un projecte amb ànima.",
          title: "RECUPERACIÓ DE BOSCOS",
          text: "Treballem activament en la neteja i revitalització de les boscúries del Parc Natural del Montseny, recuperant castanyers centenaris que havien estat abandonats.",
        },
        {
          eyebrow:
            "ATRIBUTS QUE FAN DE LA NOSTRA CASTANYA UN INGREDIENT CLAU A LA CUINA",
          intro:
            "El nostre producte destaca en el paladar professional per tres característiques clau derivades del seu origen.",
          title: "COMPROMÍS SOSTENIBLE",
          text: "Som un projecte de km 0 que aposta per l'economia circular i la preservació del territori. Servir les nostres castanyes és explicar una història de respecte per la natura als teus clients.",
        },
        {
          eyebrow:
            "ATRIBUTS QUE FAN DE LA NOSTRA CASTANYA UN INGREDIENT CLAU A LA CUINA",
          intro:
            "El nostre producte destaca en el paladar professional per tres característiques clau derivades del seu origen.",
          title: "TRIATGE I SELECCIÓ MANUAL",
          text: "El nostre valor diferencial és el factor humà. Revisem cada fruit per garantir que només el millor calibre i estat arribi a la teva cuina.",
        },
      ],
    },
    es: {
      ...
      contactSuccess:
        "Consulta enviada correctamente. Joaquim te respondera lo antes posible.",
      contactError:
        "No hemos podido enviar la consulta ahora mismo. Intentalo de nuevo en unos minutos.",
      bookingSending: "Enviando solicitud...",
      bookingSuccess:
        "Solicitud enviada correctamente. Recibiras un correo de confirmacion en breve.",
      bookingError:
        "No hemos podido enviar la solicitud ahora mismo. Intentalo de nuevo en unos minutos.",
      cartFormatRequired:
        "Selecciona un formato antes de anadirlo a la cesta.",
      cartInvalidProduct:
      ...
      checkoutInvalidPhone:
        "Introduce un telefono valido con extension internacional si es necesario.",
      checkoutPickupStoreRequired:
        "Selecciona la tienda donde quieres recoger el pedido.",
      checkoutAcceptLegal: "Debes aceptar el Aviso legal para continuar.",
      checkoutAcceptPrivacy:
        "Debes aceptar la Politica de privacidad para continuar.",
      checkoutAcceptFulfillment:
        "Debes confirmar que entiendes las condiciones de envio y recogida.",
      orderCreateError: "No hemos podido crear el pedido.",
      resumePaymentPending: "Reanudando el pago de tu pedido...",
      resumeAlreadyPaid: "Este pedido ya se ha pagado correctamente.",
      resumeGenericError:
        "No hemos podido reanudar el pago de este pedido. Vuelve a hacer el pedido desde la cesta o contacta con nosotros.",
      cartTitleHasItems: "REVISA TU CESTA",
      cartTitleEmpty: "TODAVIA NO HAY NINGUN PRODUCTO EN TU CESTA",
      cartIntroHasItems:
        "Puedes ajustar cantidades, eliminar productos y dejar listos los datos de envio antes de pasar al backend de pedidos.",
      cartIntroEmpty:
        "Cuando anadas productos desde la tienda, los encontraras aqui para revisar formatos, cantidades y el resumen del pedido.",
      shippingToCalculate: "A calcular en el proximo paso",
      shippingPickupFree: "Recogida en tienda (gratis)",
      shippingFree: "Gratis",
      cartSummaryNote:
        "La cesta se guarda en este navegador hasta que finalices la compra.",
      cartCtaBackToShop: "VOLVER A LA TIENDA",
      cartCtaKeepShopping: "SEGUIR COMPRANDO",
      cartItemFormatLabel: "Formato",
      cartItemUnitPriceLabel: "Precio unitario",
      cartItemQtyAria: "Cantidad",
      cartItemRemove: "Eliminar",
      shippingWarning: (min, cost) =>
        `Como el pedido no llega a ${min}, se anadira un coste de envio de ${cost}. Tambien puedes seleccionar recogida en tienda para evitarlo.`,
      checkoutCartEmpty:
        "La cesta esta vacia. Anade algun producto antes de continuar.",
      checkoutInvalidSku:
        "Hay un producto en la cesta sin SKU. Vuelve a anadir los productos a la cesta.",
      checkoutPreparing: "PREPARANDO EL PEDIDO...",
      checkoutCreatingOrder:
        "Creando el pedido y preparando el paso de pago...",
      checkoutOrderCreated: (code) =>
        `Pedido ${code} creado. Redirigiendo hacia el pago...`,
      checkoutPaymentUnavailable:
        "No hemos podido iniciar el pago ahora mismo. Intentalo de nuevo en unos minutos o contacta con nosotros.",
      checkoutPaymentPrepError:
        "No hemos podido preparar el pago ahora mismo.",
      checkoutGenericError: "Ha habido un error al preparar el pedido.",
      checkoutSubmitLabel: "CONTINUAR HACIA EL PAGO",
      professionalsSlides: [
        {
          eyebrow:
            "NUESTRO VALOR AÑADIDO: MÁS QUE UN INGREDIENTE, UN PROYECTO",
          intro:
            "Al elegir la Castanya de Viladrau como tu proveedor de confianza, tu establecimiento se une a un proyecto con alma.",
          title: "RECUPERACIÓN DE BOSQUES",
          text: "Trabajamos activamente en la limpieza y revitalización de las masas forestales del Parque Natural del Montseny, recuperando castaños centenarios que habían sido abandonados.",
        },
        {
          eyebrow:
            "ATRIBUTOS QUE HACEN DE NUESTRA CASTAÑA UN INGREDIENTE CLAVE EN LA COCINA",
          intro:
            "Nuestro producto destaca en el paladar profesional por tres características clave derivadas de su origen.",
          title: "COMPROMISO SOSTENIBLE",
          text: "Somos un proyecto de km 0 que apuesta por la economía circular y la preservación del territorio. Servir nuestras castañas es contar una historia de respeto por la naturaleza a tus clientes.",
        },
        {
          eyebrow:
            "ATRIBUTOS QUE HACEN DE NUESTRA CASTAÑA UN INGREDIENTE CLAVE EN LA COCINA",
  ...
  const setupLangSwitcher = () => {
    const instances = Array.from(document.querySelectorAll(".lang-switcher"))
      .map((switcher) => {
        const toggle = switcher.querySelector(".lang-switcher__toggle");
        return toggle ? { switcher, toggle } : null;
      })
      .filter(Boolean);
    ...
    const closeAll = () => {
      instances.forEach(({ switcher, toggle }) => {
        switcher.classList.remove("is-open");
        toggle.setAttribute("aria-expanded", "false");
      });
      document.body.classList.remove("has-lang-switcher-open");
    };
    ...
    instances.forEach(({ switcher, toggle }) => {
      toggle.addEventListener("click", (event) => {
        ...
        if (!isOpen) {
          ...
          // The nav bar sits right below the toggle and, depending on the
          // page, can end up winning clicks meant for the CAT/ES options
          // underneath it. Rather than rely on z-index ordering, make the
          // nav explicitly non-interactive for as long as the dropdown is
          // open so there is no ambiguity about which element gets the click.
          document.body.classList.add("has-lang-switcher-open");
        }
      });
    });

    document.addEventListener("click", (event) => {
      const clickedInsideSwitcher = instances.some(({ switcher }) =>
...
`,
    ...
    const slides = t.professionalsSlides.map((slide, index) => ({
      ...slide,
  ...
  const setupVisitBooking = () => {
    ...
    form.addEventListener("submit", async (event) => {
      ...
      submitButton.disabled = true;
      status.textContent = t.bookingSending;
      ...
      try {
        ...
        status.textContent = t.bookingError;
      } finally {
        submitButton.disabled = false;
      }
    });
  ...
  const setupCart = () => {
    ...
    const getCheckoutValidationError = (payload) => {
      ...
      if (missingField) {
        return {
          field: missingField,
          message: t.checkoutMissingFields,
        };
      }
      ...
      if (!isValidEmail(payload.email)) {
        return {
          field: "email",
          message: t.checkoutInvalidEmail,
        };
      }
      ...
      if (!isValidInternationalPhone(payload.phone)) {
        return {
          field: "phone",
          message: t.checkoutInvalidPhone,
        };
      }
      ...
      if (isPickup && !String(payload.pickupStore || "").trim()) {
        return {
          field: "pickupStore",
          message: t.checkoutPickupStoreRequired,
        };
      }
      ...
      if (payload.acceptPrivacy !== "on") {
        return {
          field: "acceptPrivacy",
          message: t.checkoutAcceptPrivacy,
        };
      }
      ...
      if (payload.acceptFulfillmentTerms !== "on") {
        return {
          ...
          message: t.checkoutAcceptFulfillment,
        };
      }
        ...
        button.addEventListener("click", () => {
          ...
          if (requiresFormatSelection && !formatSelected) {
            if (feedbackNode) {
              feedbackNode.hidden = false;
              feedbackNode.dataset.state = "error";
              feedbackNode.textContent = t.cartFormatRequired;
            }
          ...
          if (
            ...
            if (feedbackNode) {
              feedbackNode.hidden = false;
              feedbackNode.dataset.state = "error";
              feedbackNode.textContent = t.cartInvalidProduct;
            }
            return;
          }
          ...
          if (feedbackNode) {
            ...
            feedbackNode.textContent = t.cartProductAdded;
          }
        });
      });
    };
    ...
    const bindCartPage = () => {
      ...
      const handleResumePayment = async () => {
        ...
        resumeMessage.textContent = t.resumePaymentPending;
        ...
        try {
          ...
          resumeMessage.textContent =
            paymentResult.data?.error === "Order already paid"
              ? t.resumeAlreadyPaid
              : t.resumeGenericError;
        } catch (error) {
          resumeMessage.dataset.state = "error";
          resumeMessage.textContent = t.resumeGenericError;
        }
      };
      ...
      const renderShippingMinimumWarning = () => {
        ...
        shippingWarningNode.textContent = t.shippingWarning(
          formatMoney(shippingMinimumAmount),
      ...
      const renderCartPage = () => {
        ...
        if (shippingNode) {
          if (!hasItems) {
            shippingNode.textContent = t.shippingToCalculate;
          } else if (isPickup) {
            shippingNode.textContent = t.shippingPickupFree;
          } else if (shippingFee > 0) {
            shippingNode.textContent = formatMoney(shippingFee);
          } else {
            shippingNode.textContent = t.shippingFree;
          }
        }
        if (totalNode) {
              ...
              <article class="shop-cart-item${unavailable ? " is-unavailable" : ""}" data-cart-item data-sku="${item.sku}" data-slug="${item.productSlug}" data-variant="${item.variantLabel}">
                ...
                <div class="shop-cart-item__body">
                  <div class="shop-cart-item__top">
                    <div>
                      ...
                      <div class="shop-cart-item__meta">
                        <p class="shop-cart-item__variant">${t.cartItemFormatLabel}: ${item.variantLabel}</p>
                        <p class="shop-cart-item__price">${t.cartItemUnitPriceLabel}: ${formatMoney(item.unitPrice)}</p>
                      </div>
                    </div>
                  ...
                  <div class="shop-cart-item__actions">
                    ...
                    <button type="button" class="shop-cart-item__remove" data-cart-remove>${t.cartItemRemove}</button>
                  </div>
                </div>
              </article>
            `;
      ...
      checkoutForm?.addEventListener("submit", async (event) => {
        ...
        if (!cart.items.length) {
          if (checkoutMessage) {
            checkoutMessage.dataset.state = "error";
            checkoutMessage.textContent = t.checkoutCartEmpty;
          }
          return;
        }
        ...
        if (invalidItem) {
          if (checkoutMessage) {
            checkoutMessage.dataset.state = "error";
            checkoutMessage.textContent = t.checkoutInvalidSku;
          }
          return;
        }
        ...
        if (checkoutSubmitButton) {
          ...
          checkoutSubmitButton.textContent = t.checkoutPreparing;
        }

        try {
          if (checkoutMessage) {
            checkoutMessage.dataset.state = "success";
            checkoutMessage.textContent = t.checkoutCreatingOrder;
          }
          ...
          if (
            ...
            if (checkoutMessage) {
              checkoutMessage.dataset.state = "success";
              checkoutMessage.textContent = t.checkoutOrderCreated(
          ...
          if (paymentResult.status === 503) {
            if (checkoutMessage) {
              checkoutMessage.dataset.state = "error";
              checkoutMessage.textContent = t.checkoutPaymentUnavailable;
            }
            return;
          }
          ...
          throw new Error(
            paymentResult.data?.details ||
              ...
              t.checkoutPaymentPrepError,
          );
        } catch (error) {
          if (checkoutMessage) {
            checkoutMessage.dataset.state = "error";
            checkoutMessage.textContent =
              error.message || t.checkoutGenericError;
          }
        } finally {
          if (checkoutSubmitButton) {
